...
pixi global install conda-self
```
...
It is possible to list all of the versions of `conda-self` available on your platform:
...
```
pixi search conda-self --channel conda-forge
```
